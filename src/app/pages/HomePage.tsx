    ...
    <>
      <section className="relative overflow-hidden border-b border-border bg-gradient-warm">
        ...
        <div className="mx-auto grid max-w-6xl items-end gap-6 px-4 pt-6 md:gap-10 md:pt-12 md:grid-cols-2 md:pb-0">
          <div className="md:pb-20">
            ...
            <Reveal delay={1}>
              <h1 className="mt-3 font-display text-3xl font-bold leading-[1.05] tracking-tight md:mt-4 md:text-6xl">
                Erősebb test.<br />
      ...
      <section className="mx-auto max-w-6xl px-4 py-24">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          ...
          <Reveal delay={3}>
            <Link to="/online-programs" className="group block h-full overflow-hidden rounded-2xl border border-border bg-card shadow-[var(--shadow-soft)] transition hover:-translate-y-1 hover:shadow-[var(--shadow-elegant)]">
              <div className="relative aspect-[4/3] overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=600&fit=crop"
                  alt="Online programok"
                  className="h-full w-full object-cover transition duration-700 group-hover:scale-110"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-primary/70 via-primary/10 to-transparent opacity-60 transition-opacity duration-500 group-hover:opacity-80"></div>
              </div>
              <div className="p-6">
                <h3 className="font-display text-xl font-semibold">Online programok</h3>
                <p className="mt-1 text-sm text-muted-foreground">
                  Core fókuszú online edzéstervek bárhol, bármikor.
                </p>
                <span className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-accent transition group-hover:gap-2">
                  Részletek
                  <ArrowRight className="h-4 w-4" />
